/**
 * Componente Button reutilizable y estilizado con Tailwind CSS.
 * Soporta variantes, tamaños y estados.
 */

import React from 'react';
import { ark } from '@ark-ui/react'; // Ejemplo de uso de Ark UI para partes headless

// Definición de variantes de estilo con clases de Tailwind
...
const Button = ({
  ...
  const baseClasses = 'inline-flex items-center justify-center font-medium rounded-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-900 disabled:opacity-50 disabled:cursor-not-allowed';
